...
#define STUDENT_NUMBER    "18039133"
...
void Group_1(BYTE opcode){
	...
	switch(opcode) {
		...
		/*-------------------------------------------------------------
		loads accumulator A with the contents of an address in memory
		-------------------------------------------------------------*/

		case 0x43: //LD Immidiate //LD(#)
			data = fetch(); //fetch returns the total available memory(?)
		...
		case 0x93: //LD(zpg)
			...
			/*-------------------------------------------------------------
			LODY - load memory into register Y
			-------------------------------------------------------------*/
		...
		case 0x72: //LODY (zpg)
			...
			/*-------------------------------------------------------------
			LODS - Load memory into Stackpointer
			-------------------------------------------------------------*/
		case 0x20: //LODS(#)
			data = fetch();
		...
		case 0x70: //LODS (zpg)
			...
			/*--------------------------------------------------
			STO stores the contents of the Accumulator to memory
			--------------------------------------------------*/
		...
		case 0x44: //STO (zpg)
			...
			/*---
			STOY - Store register X into memory
			---*/
		...
		case 0x45: //STOY (zpg)
			...
			/*--------------------------------------------------
			STOS - Store Stackpointer into Memory
			--------------------------------------------------*/
		...
		case 0x4F: //STO (zpg)
			...
			/*--------------------------------------------------
			TAY - transfer data in Accumulator to Register Y
			--------------------------------------------------*/
		case 0x2B:
			...
			/*--------------------------------------------------
			TYA - transfer data from Register Y into Accumulator
			--------------------------------------------------*/
		case 0x2C:
...
Description: Moves contents of one register and puts it into another.
Parameters:
Returns:
Warnings:
---------------------------------*/
